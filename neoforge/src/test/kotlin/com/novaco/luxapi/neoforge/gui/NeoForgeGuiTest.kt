...
class NeoForgeGuiTest {
    ...
    fun `test hasViewers reflects open and close`() {
        ...
        val gui = NeoForgeGui("Viewer Test", 1, emptyMap())
    ...
    fun `test onViewerRemoved untracks a client-initiated close without calling close`() {
        ...
        // Simulates NeoForgeMenu.removed() firing for an ESC/inventory-swap/disconnect close.
    ...
    fun `test refreshAll synchronizes every tracked viewer`() {
        ...
        val firstLuxPlayer = mock<NeoForgeLuxPlayer>()
        ...
        val secondLuxPlayer = mock<NeoForgeLuxPlayer>()
        ...
        val gui = NeoForgeGui("Refresh All Test", 1, emptyMap())
