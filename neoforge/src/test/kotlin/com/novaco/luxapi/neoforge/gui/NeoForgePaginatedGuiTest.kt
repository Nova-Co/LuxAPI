...
class NeoForgePaginatedGuiTest {
    ...
    private fun createMockPlayer(): NeoForgeLuxPlayer {
        ...
        // Setup dummy container menu for refresh logic using Reflection
    ...
    fun `test pagination math and page boundaries`() {
        ...
        val contentSlots = listOf(10, 11, 12, 13) // 4 slots available per page

        val gui = NeoForgePaginatedGuiBuilder()
            .title("Paginated")
            .rows(3)
            .globalItems(globalItems)
            .contentSlots(contentSlots)
            .build() as NeoForgePaginatedGui
    ...
    fun `test slot rendering updates container accurately`() {
        ...
        val contentSlots = listOf(0, 1) // 2 slots per page

        val gui = NeoForgePaginatedGui("Test", 1, emptyMap(), globalItems, contentSlots)
        val player = createMockPlayer()
